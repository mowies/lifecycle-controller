...
## [0.8.3](https://github.com/mowies/lifecycle-controller/compare/metrics-operator-v0.8.2...metrics-operator-v0.8.3) (2023-09-26)
...
* add `interval` field for `kubectl get KeptnMetric` ([#1689](https://github.com/mowies/lifecycle-controller/issues/1689)) ([1599ee9](https://github.com/mowies/lifecycle-controller/commit/1599ee939c94c6dbdf6207796b7b4e5211c2cbf7))
...
* aggregation functions support for metrics controller ([#1802](https://github.com/mowies/lifecycle-controller/issues/1802)) ([678c4c9](https://github.com/mowies/lifecycle-controller/commit/678c4c9efaa53eb2bb64ef31c98a08d92eccd810))
...
* **metrics-operator:** adapt to changes in DQL API ([#1948](https://github.com/mowies/lifecycle-controller/issues/1948)) ([88d693a](https://github.com/mowies/lifecycle-controller/commit/88d693af82d41656a991546b4cef555c5171ffdf))
...
* **metrics-operator:** add new provider interface ([#1943](https://github.com/mowies/lifecycle-controller/issues/1943)) ([66320f8](https://github.com/mowies/lifecycle-controller/commit/66320f893c1bfc88b2e5a03d77caecaa0b42681f))
* **metrics-operator:** convert corner cases in SLO convertor ([#1999](https://github.com/mowies/lifecycle-controller/issues/1999)) ([95e0953](https://github.com/mowies/lifecycle-controller/commit/95e0953c2c95ac22fe62d592c4ff6dd186e6a260))
...
* **metrics-operator:** introduce scoring logic for Analysis evaluations ([#1872](https://github.com/mowies/lifecycle-controller/issues/1872)) ([b6f2172](https://github.com/mowies/lifecycle-controller/commit/b6f2172637481a395fcd48d428ab39780f5c0fa8))
* **metrics-operator:** introduce SLI -&gt; AnalysisValueTemplate converter ([#1939](https://github.com/mowies/lifecycle-controller/issues/1939)) ([6f2d261](https://github.com/mowies/lifecycle-controller/commit/6f2d2614c2fcd6b83edfa77db01255a666e0b07b))
* **metrics-operator:** introduce SLO -&gt; AnalysisDefinition converter ([#1955](https://github.com/mowies/lifecycle-controller/issues/1955)) ([9c9929c](https://github.com/mowies/lifecycle-controller/commit/9c9929c6f0cf1d51baedc6ddb40f0b0f25ddc228))
* **metrics-operator:** support combination of OR criteria in SLO converter ([#2023](https://github.com/mowies/lifecycle-controller/issues/2023)) ([aa430e7](https://github.com/mowies/lifecycle-controller/commit/aa430e7f106949e1ee3108bc08c2e604d3e25a9b))
* **metrics-operator:** update datadog api to support `range.step` ([#1842](https://github.com/mowies/lifecycle-controller/issues/1842)) ([1d957b7](https://github.com/mowies/lifecycle-controller/commit/1d957b724c5db7679bf32a33441f96108537d8e3))
* **metrics-operator:** update dql provider to include range ([#1919](https://github.com/mowies/lifecycle-controller/issues/1919)) ([39db23e](https://github.com/mowies/lifecycle-controller/commit/39db23e60c6d6f0a8f298bae045abf374877d7f1))
* **metrics-operator:** update dynatrace api to support `range.step` ([#1812](https://github.com/mowies/lifecycle-controller/issues/1812)) ([4407fc4](https://github.com/mowies/lifecycle-controller/commit/4407fc4f3878ba5897991734df7e38fc273531a9))
...
* update Datadog API to query metrics for range ([#1615](https://github.com/mowies/lifecycle-controller/issues/1615)) ([3b370ab](https://github.com/mowies/lifecycle-controller/commit/3b370abd2c887ea939f8a22c4c36babecb114265))
* update Dynatrace provider to query metrics over a range ([#1658](https://github.com/mowies/lifecycle-controller/issues/1658)) ([0f0cddb](https://github.com/mowies/lifecycle-controller/commit/0f0cddb2b6cd97aadff4da266c8d15f8ecab2881))
* update prometheus api to support `range.step` ([#1801](https://github.com/mowies/lifecycle-controller/issues/1801)) ([e64fcd6](https://github.com/mowies/lifecycle-controller/commit/e64fcd6d63cb87d76e83fc7e718f387953a0ff02))


### Bug Fixes

* **metrics-operator:** fix url encoding in DT metrics queries ([#1893](https://github.com/mowies/lifecycle-controller/issues/1893)) ([5437df9](https://github.com/mowies/lifecycle-controller/commit/5437df9419a71b4f9b2ae21534839704c5a05762))
* **metrics-operator:** flaky test in SLI converter ([#1954](https://github.com/mowies/lifecycle-controller/issues/1954)) ([cadb170](https://github.com/mowies/lifecycle-controller/commit/cadb170f4a7f26443a77634f9d7fb936610b9677))
* **metrics-operator:** flaky test in SLI converter ([#1961](https://github.com/mowies/lifecycle-controller/issues/1961)) ([d02a8ef](https://github.com/mowies/lifecycle-controller/commit/d02a8efa37f8cb5319f4f0b521b1b6c2696c5461))
* **metrics-operator:** make Fail target in AnalysisDefinition optional ([#1903](https://github.com/mowies/lifecycle-controller/issues/1903)) ([df874e2](https://github.com/mowies/lifecycle-controller/commit/df874e25dcfde7ae848dbb65c9fbe846d3ce1f61))
...
* remove debug log containing secret ([#1967](https://github.com/mowies/lifecycle-controller/issues/1967)) ([75baefd](https://github.com/mowies/lifecycle-controller/commit/75baefd7b45de3dbe3e8ba0fc473ee25351a31e7))
...
* **metrics-operator:** improve performance of storing analysis results ([#1905](https://github.com/mowies/lifecycle-controller/issues/1905)) ([efe3380](https://github.com/mowies/lifecycle-controller/commit/efe33803c4878599db958dcb76c7217b9e82c77f))
...
* update github.com/keptn/lifecycle-toolkit/klt-cert-manager digest to 440c308 ([#2017](https://github.com/mowies/lifecycle-controller/issues/2017)) ([c365734](https://github.com/mowies/lifecycle-controller/commit/c365734fa7e3e40b2ae4c97c61628892d040dacc))
...
* update github.com/keptn/lifecycle-toolkit/klt-cert-manager digest to 8dbec2d ([#1995](https://github.com/mowies/lifecycle-controller/issues/1995)) ([2f51445](https://github.com/mowies/lifecycle-controller/commit/2f5144540c4b3876e800bff29c30bfded334be40))
...
* update golang.org/x/exp digest to 9212866 ([#2039](https://github.com/mowies/lifecycle-controller/issues/2039)) ([2fba7c9](https://github.com/mowies/lifecycle-controller/commit/2fba7c94ff0fa6aa14facc7dc22b1a7558a88a18))
* update golang.org/x/exp digest to d852ddb ([#2011](https://github.com/mowies/lifecycle-controller/issues/2011)) ([12ee7b6](https://github.com/mowies/lifecycle-controller/commit/12ee7b6f37c2422a37da1e53e4b9e250db6d8ca3))
...
* update module github.com/datadog/datadog-api-client-go/v2 to v2.15.0 ([#1803](https://github.com/mowies/lifecycle-controller/issues/1803)) ([ff62c60](https://github.com/mowies/lifecycle-controller/commit/ff62c6096f793307b54c0462dddf3473f2c2017d))
* update module github.com/datadog/datadog-api-client-go/v2 to v2.16.0 ([#1957](https://github.com/mowies/lifecycle-controller/issues/1957)) ([00f3cd3](https://github.com/mowies/lifecycle-controller/commit/00f3cd3f1d9f27046f31cd36924c0bed855faed2))
* update module github.com/open-feature/go-sdk to v1.7.0 ([#1854](https://github.com/mowies/lifecycle-controller/issues/1854)) ([8b90008](https://github.com/mowies/lifecycle-controller/commit/8b90008fc081e0da8029ffb1d28869a01efd15e6))
...
* update module golang.org/x/net to v0.14.0 ([#2020](https://github.com/mowies/lifecycle-controller/issues/2020)) ([14573cd](https://github.com/mowies/lifecycle-controller/commit/14573cd1b3a0fec12ceb7bd3f23c3fa8432d8528))
