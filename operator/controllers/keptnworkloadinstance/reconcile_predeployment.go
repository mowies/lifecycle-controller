...
func getOverallState(summary StatusSummary) klcv1alpha1.WorkloadInstancePhase {
	if summary.failed > 0 {
		return klcv1alpha1.WorkloadInstancePhaseFailed
	}
	if summary.running > 0 {
		return klcv1alpha1.WorkloadInstancePhaseRunning
	}
	if summary.pending > 0 {
		return klcv1alpha1.WorkloadInstancePhasePending
	}
	return klcv1alpha1.WorkloadInstancePhaseSucceeded
}
