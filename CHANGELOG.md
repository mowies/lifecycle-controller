...
## [0.7.1](https://github.com/mowies/lifecycle-controller/compare/v0.7.0...v0.7.1) (2023-04-04)
...
* make examples resource footprint smaller, fix bugs ([#1171](https://github.com/mowies/lifecycle-controller/issues/1171)) ([8b165d3](https://github.com/mowies/lifecycle-controller/commit/8b165d3bf63a63b452ac2f1423166978b80facc9))
* **operator:** additional parameters for KeptnTask to support retry logic ([#1084](https://github.com/mowies/lifecycle-controller/issues/1084)) ([eed5568](https://github.com/mowies/lifecycle-controller/commit/eed5568e51f381f62e2e6db3fddc13a610bcd5e0))
* **operator:** bootstrapped KeptnAppCreationRequest CRD ([#1134](https://github.com/mowies/lifecycle-controller/issues/1134)) ([6b58da3](https://github.com/mowies/lifecycle-controller/commit/6b58da3c907af591633052ba3d7fc49a2b801ebc))
* **operator:** introduce retry logic for KeptnTasks ([#1088](https://github.com/mowies/lifecycle-controller/issues/1088)) ([e49b5a3](https://github.com/mowies/lifecycle-controller/commit/e49b5a3f133b5ba5f1ceaad53c12899415ea58b2))
* **operator:** polish `KeptnConfig` and use Env Var for initial configuration ([#1097](https://github.com/mowies/lifecycle-controller/issues/1097)) ([559acee](https://github.com/mowies/lifecycle-controller/commit/559acee5059016b96703fb9f6f8d842d3c392c29))
* use smaller distroless images for released containers ([#1092](https://github.com/mowies/lifecycle-controller/issues/1092)) ([8a7a6af](https://github.com/mowies/lifecycle-controller/commit/8a7a6af9f44c3a3f88b0a2f2331e3e820741d26f))


### Bug Fixes

* add missing control-plane label into lifecycle operator service ([#1148](https://github.com/mowies/lifecycle-controller/issues/1148)) ([df04fbe](https://github.com/mowies/lifecycle-controller/commit/df04fbe5512d1f9e0c8d8e81a253a8c4892e1dec))
* fix examples restart make command, reduce prometheus resources ([#1158](https://github.com/mowies/lifecycle-controller/issues/1158)) ([06b10a8](https://github.com/mowies/lifecycle-controller/commit/06b10a82fd3e8c942ef7592f919acb60552c4ae4))
* fix examples, update podtatohead ([#1098](https://github.com/mowies/lifecycle-controller/issues/1098)) ([f581ed5](https://github.com/mowies/lifecycle-controller/commit/f581ed500f55da2be69a10ac67da5d8717ac3104))
* generate missing CRD docs, fix validation pipeline ([#1086](https://github.com/mowies/lifecycle-controller/issues/1086)) ([71e9073](https://github.com/mowies/lifecycle-controller/commit/71e9073288c55da4ccbc51c1beb01a2d00b0921a))
* **helm-chart:** fix missing values in the KLT helm chart ([#1082](https://github.com/mowies/lifecycle-controller/issues/1082)) ([52311c1](https://github.com/mowies/lifecycle-controller/commit/52311c1a1ee023ff5d271456c1fe09737ba94d60))
* **metrics-operator:** normalize Dynatrace URL ([#1145](https://github.com/mowies/lifecycle-controller/issues/1145)) ([b33b4f4](https://github.com/mowies/lifecycle-controller/commit/b33b4f49320bf75c5098190d0b36ab3c49be9b45))
* move prometheus install into make file ([#1093](https://github.com/mowies/lifecycle-controller/issues/1093)) ([f6f44e4](https://github.com/mowies/lifecycle-controller/commit/f6f44e4c5d880f00605e2923292c039503bb7903))
* removed failure branch ([#1175](https://github.com/mowies/lifecycle-controller/issues/1175)) ([66df012](https://github.com/mowies/lifecycle-controller/commit/66df01257a1abce26e4b3577527a8fbe651358d6))
* use correct control-plane label for metrics-operator ([#1147](https://github.com/mowies/lifecycle-controller/issues/1147)) ([1035183](https://github.com/mowies/lifecycle-controller/commit/10351834d70b000b8296bea65b80fc9e22e54cee))


### Dependency Updates

* remove github.com/open-feature/flagd ([#1110](https://github.com/mowies/lifecycle-controller/issues/1110)) ([e118851](https://github.com/mowies/lifecycle-controller/commit/e11885180bcab7dac93409fd5868328c6dade508))
...
* update amannn/action-semantic-pull-request action to v5.2.0 ([#1102](https://github.com/mowies/lifecycle-controller/issues/1102)) ([c57b1fe](https://github.com/mowies/lifecycle-controller/commit/c57b1febc0501648c5c2d3c94c4434536ece2871))
* update anchore/sbom-action action to v0.13.4 ([#1101](https://github.com/mowies/lifecycle-controller/issues/1101)) ([4c9a1aa](https://github.com/mowies/lifecycle-controller/commit/4c9a1aabe6550d21d80c8696421203896847297e))
* update curlimages/curl docker tag to v8 ([#1116](https://github.com/mowies/lifecycle-controller/issues/1116)) ([05bf675](https://github.com/mowies/lifecycle-controller/commit/05bf6750563d8956dd29a8964dea1a79136db810))
...
* update dependency argoproj/argo-cd to v2.6.7 ([#1121](https://github.com/mowies/lifecycle-controller/issues/1121)) ([97c4b58](https://github.com/mowies/lifecycle-controller/commit/97c4b5823398310c11f50ff94d6c4cb4a29526a2))
* update dependency golangci/golangci-lint to v1.52.0 ([#1103](https://github.com/mowies/lifecycle-controller/issues/1103)) ([2b28b4f](https://github.com/mowies/lifecycle-controller/commit/2b28b4f58fb14421a704225cf437d08cba6b27b6))
* update dependency golangci/golangci-lint to v1.52.1 ([#1108](https://github.com/mowies/lifecycle-controller/issues/1108)) ([f5fb9ea](https://github.com/mowies/lifecycle-controller/commit/f5fb9ead9a53ad9fbd458df8c8b6aa6bfaa720da))
* update dependency golangci/golangci-lint to v1.52.2 ([#1142](https://github.com/mowies/lifecycle-controller/issues/1142)) ([1071f02](https://github.com/mowies/lifecycle-controller/commit/1071f0297b59bbd3a755e0a21c8e894bbfde1907))
...
* update dependency jaegertracing/jaeger-operator to v1.43.0 ([#1152](https://github.com/mowies/lifecycle-controller/issues/1152)) ([9890213](https://github.com/mowies/lifecycle-controller/commit/9890213a643aac0977f677ac181d1d39e77fa5b5))
* update github.com/keptn/lifecycle-toolkit/metrics-operator digest to 6b58da3 ([#1141](https://github.com/mowies/lifecycle-controller/issues/1141)) ([3859059](https://github.com/mowies/lifecycle-controller/commit/385905913f867c88482e5b1a40643a8957a8e022))
* update github.com/keptn/lifecycle-toolkit/metrics-operator digest to 720e9e9 ([#1035](https://github.com/mowies/lifecycle-controller/issues/1035)) ([8a77f00](https://github.com/mowies/lifecycle-controller/commit/8a77f0004bc643a45890a888f3b7942f0c4ef794))
* update github.com/keptn/lifecycle-toolkit/metrics-operator digest to b32d753 ([#1164](https://github.com/mowies/lifecycle-controller/issues/1164)) ([4480444](https://github.com/mowies/lifecycle-controller/commit/448044446a315973cbf80fb4d9a24e58bb797eb5))
* update github.com/keptn/lifecycle-toolkit/metrics-operator digest to f5fb9ea ([#1107](https://github.com/mowies/lifecycle-controller/issues/1107)) ([65f6a83](https://github.com/mowies/lifecycle-controller/commit/65f6a832a60a63226170b342d79ca187bddb6cec))
* update golang docker tag to v1.20.2 ([#1036](https://github.com/mowies/lifecycle-controller/issues/1036)) ([720e9e9](https://github.com/mowies/lifecycle-controller/commit/720e9e9b7040a1048d3f6fc86917bd678436c437))
* update kubernetes packages to v0.26.3 (patch) ([#1072](https://github.com/mowies/lifecycle-controller/issues/1072)) ([a6459f8](https://github.com/mowies/lifecycle-controller/commit/a6459f8c2cd98fac9897ca40e299790ba35cd569))
* update module github.com/datadog/datadog-api-client-go/v2 to v2.11.0 ([#1109](https://github.com/mowies/lifecycle-controller/issues/1109)) ([fbc021e](https://github.com/mowies/lifecycle-controller/commit/fbc021eadaf2442bfa67bc32947193b7fb6c20ae))
* update module github.com/go-logr/logr to v1.2.4 ([#1153](https://github.com/mowies/lifecycle-controller/issues/1153)) ([c1ecfd0](https://github.com/mowies/lifecycle-controller/commit/c1ecfd03e39fc72f8304c78f80e71941aa0162e9))
* update module github.com/imdario/mergo to v0.3.14 ([#1073](https://github.com/mowies/lifecycle-controller/issues/1073)) ([ad408fd](https://github.com/mowies/lifecycle-controller/commit/ad408fd3b2dbd8480baad0c730b3f209c0d3b503))
* update module github.com/imdario/mergo to v0.3.15 ([#1132](https://github.com/mowies/lifecycle-controller/issues/1132)) ([17baf34](https://github.com/mowies/lifecycle-controller/commit/17baf3499a8681a850dfa7d88d049c26b86f8784))
* update module github.com/onsi/gomega to v1.27.4 ([#967](https://github.com/mowies/lifecycle-controller/issues/967)) ([502189a](https://github.com/mowies/lifecycle-controller/commit/502189ad73ed9abc9bedb89bd701258ac729024e))
* update module github.com/onsi/gomega to v1.27.5 ([#1133](https://github.com/mowies/lifecycle-controller/issues/1133)) ([7d0cf4b](https://github.com/mowies/lifecycle-controller/commit/7d0cf4b87d3c897ad348e9d1d31284710f99fbd0))
* update module github.com/onsi/gomega to v1.27.6 ([#1166](https://github.com/mowies/lifecycle-controller/issues/1166)) ([ab3a091](https://github.com/mowies/lifecycle-controller/commit/ab3a091748b4d3cdccad4854edfaf01798387376))
* update module github.com/prometheus/common to v0.42.0 ([#1111](https://github.com/mowies/lifecycle-controller/issues/1111)) ([7ac89de](https://github.com/mowies/lifecycle-controller/commit/7ac89de96afd21e63c5d77465880f9428a822213))
* update module github.com/spf13/afero to v1.9.5 ([#1037](https://github.com/mowies/lifecycle-controller/issues/1037)) ([108e2a5](https://github.com/mowies/lifecycle-controller/commit/108e2a50764677dfe2bf6568c35bc2187ddcc206))
* update module github.com/stretchr/testify to v1.8.2 ([#937](https://github.com/mowies/lifecycle-controller/issues/937)) ([ddd3732](https://github.com/mowies/lifecycle-controller/commit/ddd3732423cffa1d11bf7b0cef86a8229c3216e2))
...
* update module google.golang.org/grpc to v1.54.0 ([#1112](https://github.com/mowies/lifecycle-controller/issues/1112)) ([ad2dc51](https://github.com/mowies/lifecycle-controller/commit/ad2dc511b9dcd3a8bc3bcd17e6344c9251a17a39))
* update module k8s.io/kubernetes to v1.25.8 ([#938](https://github.com/mowies/lifecycle-controller/issues/938)) ([65b854a](https://github.com/mowies/lifecycle-controller/commit/65b854ac9d02057e2bb99c270f629a44d67f258d))
* update module sigs.k8s.io/controller-runtime to v0.14.5 ([#1038](https://github.com/mowies/lifecycle-controller/issues/1038)) ([1be4f11](https://github.com/mowies/lifecycle-controller/commit/1be4f11872a634a037ed60cdf07ecf4a58c3b2c0))
* update module sigs.k8s.io/controller-runtime to v0.14.6 ([#1160](https://github.com/mowies/lifecycle-controller/issues/1160)) ([5f0071d](https://github.com/mowies/lifecycle-controller/commit/5f0071d114e28863192427e33ac5daa412418995))
...
* improve rendering of links for local markdown files ([#1177](https://github.com/mowies/lifecycle-controller/issues/1177)) ([070bbee](https://github.com/mowies/lifecycle-controller/commit/070bbee37ee44be3f8f2c7f03078c3276ee317e3))
* make cert-manager and manifest installation a detail ([#1099](https://github.com/mowies/lifecycle-controller/issues/1099)) ([66b3f01](https://github.com/mowies/lifecycle-controller/commit/66b3f013bba551be7471088a53b117242a34b543))
* **operator:** adjust docs comment ([#1126](https://github.com/mowies/lifecycle-controller/issues/1126)) ([4078fad](https://github.com/mowies/lifecycle-controller/commit/4078fada7a1c8a5a392aa11fe0f161acf190478d))
* set up top-level Installation section ([#1162](https://github.com/mowies/lifecycle-controller/issues/1162)) ([2c62593](https://github.com/mowies/lifecycle-controller/commit/2c6259366a5ff545404dad2c692b7f1db524de83))
...
* update list of videos about KLT ([#1105](https://github.com/mowies/lifecycle-controller/issues/1105)) ([ade49e1](https://github.com/mowies/lifecycle-controller/commit/ade49e1fd8d4cb9b811fb4b4be871c1907f124ad))


### Other

* improve CRD docs generation script output ([#1157](https://github.com/mowies/lifecycle-controller/issues/1157)) ([b27adf1](https://github.com/mowies/lifecycle-controller/commit/b27adf1edc297dd7723998fcf4960929b2b2952d))
* **operator:** read-only RBAC for KeptnConfig controller ([#1096](https://github.com/mowies/lifecycle-controller/issues/1096)) ([ea91ff3](https://github.com/mowies/lifecycle-controller/commit/ea91ff36dfbe13811143031462407fecf7791596))
* set up YAML linter rules, fix YAML files accordingly ([#1174](https://github.com/mowies/lifecycle-controller/issues/1174)) ([86fbb75](https://github.com/mowies/lifecycle-controller/commit/86fbb757e55cb959e8ccb2ddc62bfcba55271452))
